...
public class CreateTestRobot : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        root.transform.position = new Vector3(-1.55f, 0.6f, -1.43f);
        root.transform.rotation = new Quaternion(0.0f, -90f, 0.0f, 0f);
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.D))
        {
            ...
            GameObject root = GameObject.Find("Sphere");
            root.transform.Translate(Vector3.left * Time.deltaTime * 10);
            ObjectJoint.SetJoints(testList, GameObject.Find("Sphere"));
        }
